...
class _SubdomainFinderPageState extends State<SubdomainFinderPage> {
  ...
  Future<void> _findSubdomains() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://marxxxnotdev.danzxncloud.biz.id:11662/api/tools/subdomain-finder?key=${widget.sessionKey}&domain=${_domainController.text}'));
