...
class _DashboardPageState extends State<DashboardPage> with SingleTickerProviderStateMixin {
  ...
  void _connectToWebSocket() {
    channel = WebSocketChannel.connect(Uri.parse('http://marxxxnotdev.danzxncloud.biz.id:11662'));
  ...
  Future<void> _fetchActivityLogs() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://marxxxnotdev.danzxncloud.biz.id:11662/api/user/getActivityLogs?key=$sessionKey'),
      );
  ...
  Widget _buildAccountStatsCard() {
    const pinkColor = Color(0xFFFF1493);
