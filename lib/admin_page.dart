...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(Uri.parse('http://marxxxnotdev.danzxncloud.biz.id:11662/api/user/listUsers?key=$sessionKey'));
  ...
  Future<void> _deleteUser(String username) async {
    setState(() => isLoading = true);
    try {
      final res = await http.get(Uri.parse('http://marxxxnotdev.danzxncloud.biz.id:11662/api/user/deleteUser?key=$sessionKey&username=$username'));
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse('http://marxxxnotdev.danzxncloud.biz.id:11662/api/user/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole');
  ...
  Color _getRoleColor(String role) {
    switch (role.toLowerCase()) {
      ...
      case 'founder': return Colors.redAccent;
